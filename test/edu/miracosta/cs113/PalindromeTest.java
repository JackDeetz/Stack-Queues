...
public class PalindromeTest {
    ...
    private boolean isPalindrome(String s) {
        ...
        ArrayListStack<Character> stackOne = new ArrayListStack<Character>() ;
        ArrayListStack<Character> stackTwo = new ArrayListStack<Character>() ;
        ...
        {
           // System.out.println(Character.toLowerCase(stackOne.peek()) + " and " + Character.toLowerCase(stackTwo.peek()));//Testing
            if(Character.toLowerCase(stackOne.pop()) != Character.toLowerCase(stackTwo.pop()))
                return false ;
        }
        return true ;
